...
class VanillaGrad(object):
    ...
    def __init__(self, pretrained_model, cuda=False,device=None,task_name=None):
...
class SmoothGrad(VanillaGrad):
    ...
    def __init__(self, pretrained_model, cuda=False, device=None,stdev_spread=0.15,
                 n_samples=25, magnitude=True,task_name=None):
        super(SmoothGrad, self).__init__(pretrained_model, cuda,device)
        """
        self.pretrained_model = pretrained_model
        self.features = pretrained_model.features
        self.cuda = cuda
    ...
    def __call__(self, x, index=None):
        ...
        for i in range(self.n_samples):
            ...
            output = self.pretrained_model(x_plus_noise)[self.task_name]
